...
export default function ClaraverseComponents() {
  return (
    <Layout>
      <motion.div 
      ...
      >
        <div className="card">
          <h2 className="text-xl font-semibold mb-4">ClaraVerse UI/UX Components</h2>
          <p className="text-gray-600 mb-4">
            Create interactive node networks and custom UI controls using ReactFlow and Framer Motion.
          </p>
