const ERROR_N8N_ENV_VARS_MISSING = "N8N_API_URL and N8N_API_KEY must be defined in environment variables";
...
export async function triggerWorkflow(
  ...
  if (!n8nApiUrl || !n8nApiKey) {
    throw new Error(ERROR_N8N_ENV_VARS_MISSING)
  }
...
export class N8nClient {
  ...
  constructor(apiUrl?: string, apiKey?: string) {
    ...
    if (!this.apiUrl || !this.apiKey) {
      throw new Error(ERROR_N8N_ENV_VARS_MISSING) // Reusing the same constant as the meaning is identical
    }
  }
